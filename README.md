...
|------------|-------------|------|
| device_X6886 | x6886: always use the prebuilt kernel instead of buildi [f12ea9e](https://github.com/Il103/android_device_infinix_x6886/commit/f12ea9e) | 7d ago |
| vendor_X6886 | Update BoardConfigVendor.mk [7b014cf](https://github.com/Il103/vendor_infinix_x6886/commit/7b014cf) | 7d ago |
| manifest_X6886 | manifest: drop kernel/common now that we always use the [0260c9d](https://github.com/Il103/android_manifest_x6886/commit/0260c9d) | 7d ago |
| twrp_device_X6886 | Update TARGET_DEVICE condition in Android.mk [2d0e173](https://github.com/Il103/twrp_device_infinix_X6886/commit/2d0e173) | 10d ago |
| Il103 | profile: auto-update [f73eaa9](https://github.com/Il103/Il103/commit/f73eaa9) | 57m ago |
| X6886-TWRP-Tree-Forge | fix: carry Trustonic runtime evidence and mount persist [de2ccfd](https://github.com/Il103/X6886-TWRP-Tree-Forge/commit/de2ccfd) | 20h ago |
| demo-sample-project | Add System & Data Manager Suite implementation [7d45027](https://github.com/Il103/demo-sample-project/commit/7d45027) | 22h ago |

*Last updated: 2026-08-10 18:35:43 UTC*
<!-- LIVE-END -->
